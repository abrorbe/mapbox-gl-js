...
class CircleStrokeColorPaintVertexStructArray extends StructArray {
    uint8: Uint8Array;
    float32: Float32Array;

    geta_circle_stroke_color0(index: number) {
        return this.float32[index * 2 + 0];
    }
    geta_circle_stroke_color1(index: number) {
    ...
    static deserialize(input: SerializedStructArray): CircleStrokeColorPaintVertexStructArray {
        const structArray = Object.create(CircleStrokeColorPaintVertexStructArray.prototype);
...
CircleStrokeColorPaintVertexStructArray.prototype.bytesPerElement = 8;
CircleStrokeColorPaintVertexStructArray.prototype._usedTypes = ["Uint8", "Float32"];
