...
class CircleStrokeWidthPaintVertexStructArray extends StructArray {
    uint8: Uint8Array;
    float32: Float32Array;

    geta_circle_stroke_width(index: number) {
    ...
    static deserialize(input: SerializedStructArray): CircleStrokeWidthPaintVertexStructArray {
        const structArray = Object.create(CircleStrokeWidthPaintVertexStructArray.prototype);
...
CircleStrokeWidthPaintVertexStructArray.prototype.bytesPerElement = 4;
CircleStrokeWidthPaintVertexStructArray.prototype._usedTypes = ["Uint8", "Float32"];
